...
internal class PrecisionScaleDoubleValidator<T, TProperty> : PropertyValidator<T, TProperty?>
{
	...
	public PrecisionScaleDoubleValidator(
	...
	internal override ValidationResult? Validate(ValidationContext context, ValidationOptions? options)
	{
		...
		if (ctx.ValueToValidate is not double value)
			return null;
